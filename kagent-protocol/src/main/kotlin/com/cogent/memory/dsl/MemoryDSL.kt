package com.cogent.memory.dsl

import com.cogent.memory.core.Memory
import com.cogent.memory.core.MemoryLifecycle
import com.cogent.memory.dependency.DerivedState
import com.cogent.memory.dependency.InvalidationGraph
import com.cogent.memory.dependency.deriveBlocking
import com.cogent.memory.eviction.LRUEvictionPolicy
import com.cogent.memory.snapshot.MemorySnapshot
import com.cogent.runtime.AgentRuntime
import com.cogent.runtime.AgentState
import com.cogent.runtime.agentRuntime
import com.cogent.runtime.KAgentRuntime
import com.cogent.runtime.kAgentRuntime
import com.cogent.trace.ExecutionTrace
import com.cogent.trace.ReplayEngine
...
fun ExecutionTrace.getTimelineSync(): List<com.cogent.trace.TimelineEntry> {
    return runBlocking { getTimeline() }
}

fun ExecutionTrace.getEventsSync(): List<com.cogent.trace.TraceEvent> {
    return runBlocking { getEvents() }
}

fun ExecutionTrace.getCheckpointsSync(): List<com.cogent.trace.TraceCheckpoint> {
...
suspend fun AgentRuntime.getTimelineSync(): List<com.cogent.trace.TimelineEntry> {
    return getTrace().getTimeline()
}

// ===== KAgentRuntime DSL (v0.4) =====

fun KAgentRuntime.stateChangesSync(): List<com.cogent.runtime.StateChange> = stateChanges()

fun KAgentRuntime.snapshotSync(): com.cogent.runtime.RuntimeSnapshot = snapshot()
