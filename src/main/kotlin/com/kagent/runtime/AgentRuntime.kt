...
import com.kagent.memory.dependency.RecompositionScope
...
@Deprecated("Use KAgentRuntime instead. This legacy AgentRuntime is replaced by the unified facade.", ReplaceWith("KAgentRuntime", "com.kagent.runtime.KAgentRuntime"))
class AgentRuntime(
